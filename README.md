...
# Hi, I’m Syeda Ramisa Fariha 👋

### Forward Deployed Engineer building evaluated, safety-aware AI systems

I work across **retrieval-augmented generation, agent workflows, Python APIs, evaluation, and stakeholder-facing delivery** for government and regulated organisations.

📍 Adelaide, Australia · 🧭 Forward Deployed Engineer at **The Helix Lab**

[Portfolio](https://www.github.com/Ramisa1231/ramisa-portfolio/) · [LinkedIn](https://www.linkedin.com/in/syedaramisafariha) · [Email](mailto:ramisa@thehelixlab.ai)
...
- AI evaluation, safety, grounding, and observability
...
| AI and ML | RAG, agents, embeddings, NLP, scikit-learn, evaluation |
| Engineering | FastAPI, Flask, Django, React, Tailwind CSS, Docker |
| Cloud and tools | Google Cloud, GitHub, Jira, Confluence, Wireshark |
| Delivery | Technical discovery, documentation, stakeholder collaboration |

## Background

- Master of Computer Science, The University of Adelaide
- Former university lecturer and course coordinator
- IEEE research publication and presentation experience
- Learning technology, course development, and digital transformation
- Volunteer web development and STEM engagement
